...
- `rules/`: Cursor rule packs organized as `common/` baselines plus language overlays.
...
- Do not add new peer directories such as `xxx-commands`, `yyy-rules`, or lifecycle buckets like `archived/`; place new assets under one of the carriers above.
