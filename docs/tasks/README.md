...
- `learn-gstack` — Entry: `docs/tasks/learn-gstack/README.md` — Study `references/external/gstack` (garrytan/gstack): role workflows, skill packaging; vendored Cursor/Codex tree `platforms/gstack/` + `bash scripts/bootstrap-gstack.sh`; sync reference via `references/README.md` / `scripts/sync-references.sh --only gstack`.
