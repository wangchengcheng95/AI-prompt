...
- When the user states how much discovery and alignment a maintenance task needs, exploration levels are defined in `docs/task-exploration-levels.md`; broader collaboration axes remain non-operative reference material until explicitly wired.
