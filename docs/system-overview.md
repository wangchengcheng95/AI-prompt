...
- When the user states how much discovery and alignment a maintenance task needs, exploration levels are defined in `docs/task-exploration-levels.md`; no broader collaboration-axis scheme is operative in phase 1.
