...
description: Migrate this repository's repo-local maintenance assets from root `.codex/` to root `.cursor/` with low-decision, semantic-parity rules. Use when Cursor is asked to migrate or refresh Codex-maintenance workflows, skills, scripts, or related docs for this repository.
---
