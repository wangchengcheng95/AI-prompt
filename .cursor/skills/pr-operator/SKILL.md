---
name: pr-operator
description: Manage repo-local GitHub pull request operations with a bundled wrapper script. Use when Cursor needs to push a task branch for PR work, create a pull request, view an existing pull request, or update a pull request title or body.
---
...
- From the repository root, invoke it as `./.cursor/skills/pr-operator/scripts/prctl`.
...
```bash
PRCTL="./.cursor/skills/pr-operator/scripts/prctl"
