---
name: git-start-task
description: Start a new repo-local task from the latest main branch by checking worktree safety, switching to main, fast-forwarding from origin, and creating a focused task branch. Use when Cursor is about to begin implementation or documentation work in this repository and needs a clean Git baseline.
---
