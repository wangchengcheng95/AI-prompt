---
name: pr-handoff
description: Push a repo-local task branch and prepare a ready-to-review pull request handoff, including title, summary, verification notes, risks, and the PR link or creation path. Use when Cursor has finished work on a task branch and needs to hand the result to the user without performing the final merge.
---
